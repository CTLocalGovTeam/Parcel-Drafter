...
define({
  ...
  "parcelLineLayer": {
    ...
    "startOrRotationSymbolLabel": "ã_Start and Rotate Point Symbol__________Ç",
    "startOrRotationSymbolHintText": "ã_Hint: Used to display start and rotate point symbol_________________Ç.",
